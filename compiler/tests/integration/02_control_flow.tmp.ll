...
entry:
    ...
    store i64 1, i64* %i.addr.1
    br label %while.cond.0
while.cond.0:
    %tmp0 = load i64, i64* %i.addr.1
    %tmp1 = icmp sle i64 %tmp0, 10
    br i1 %tmp1, label %while.body.0, label %while.end.0
while.body.0:
    %tmp2 = load i64, i64* %sum.addr.0
    %tmp3 = load i64, i64* %i.addr.1
    %tmp4 = add i64 %tmp2, %tmp3
    store i64 %tmp4, i64* %sum.addr.0
    %tmp5 = load i64, i64* %i.addr.1
    %tmp6 = add i64 %tmp5, 1
    store i64 %tmp6, i64* %i.addr.1
    br label %while.cond.0
while.end.0:
    %tmp7 = load i64, i64* %sum.addr.0
    ret i64 %tmp7
}
