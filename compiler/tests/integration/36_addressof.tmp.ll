...
define i64 @main() {
entry:
    %arr.addr.7 = alloca i64*
    %ptr.addr.8 = alloca i64*
    %tmp0 = call i8* @"malloc"(i64 8)
    %tmp1 = bitcast i8* %tmp0 to i64*
    store i64* %tmp1, i64** %arr.addr.7
    %tmp2 = load i64*, i64** %arr.addr.7
    %tmp3 = getelementptr i64, i64* %tmp2, i64 0
    store i64 42, i64* %tmp3
    %tmp4 = load i64*, i64** %arr.addr.7
    %tmp5 = getelementptr i64, i64* %tmp4, i64 0
    store i64* %tmp5, i64** %ptr.addr.8
    %tmp6 = load i64*, i64** %ptr.addr.8
    %tmp7 = load i64, i64* %tmp6
    %tmp8 = sub i64 %tmp7, 42
    ret i64 %tmp8
}
