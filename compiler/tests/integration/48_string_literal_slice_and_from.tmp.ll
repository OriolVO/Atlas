...
define i32 @"main"() {
entry:
    %tmp230 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.0, i64 0, i64 0
    %tmp231 = insertvalue { i8*, i64 } undef, i8* %tmp230, 0
    %tmp232 = insertvalue { i8*, i64 } %tmp231, i64 2, 1
    %tmp233 = alloca { i8*, i64 }
    store { i8*, i64 } %tmp232, { i8*, i64 }* %tmp233
    %tmp234 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp235 = extractvalue { i8*, i64 } %tmp234, 1
    %tmp236 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp237 = extractvalue { i8*, i64 } %tmp236, 1
    %tmp238 = icmp ne i64 %tmp237, 2
    br i1 %tmp238, label %if_then.15, label %if_else.16
if_then.15:
    %tmp239 = trunc i64 1 to i32
    ret i32 %tmp239
if_else.16:
    br label %if_end.17
if_end.17:
    %tmp240 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp241 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp242 = extractvalue { i8*, i64 } %tmp241, 0
    %tmp243 = getelementptr inbounds i8, i8* %tmp242, i64 0
    %tmp244 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp245 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp246 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp247 = extractvalue { i8*, i64 } %tmp246, 0
    %tmp248 = getelementptr inbounds i8, i8* %tmp247, i64 0
    %tmp249 = load i8, i8* %tmp248
    %tmp250 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp251 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp252 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp253 = extractvalue { i8*, i64 } %tmp252, 0
    %tmp254 = getelementptr inbounds i8, i8* %tmp253, i64 0
    %tmp255 = load i8, i8* %tmp254
    %tmp256 = icmp ne i8 %tmp255, 72
    br i1 %tmp256, label %if_then.18, label %if_else.19
if_then.18:
    %tmp257 = trunc i64 2 to i32
    ret i32 %tmp257
if_else.19:
    br label %if_end.20
if_end.20:
    %tmp258 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp259 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp260 = extractvalue { i8*, i64 } %tmp259, 0
    %tmp261 = getelementptr inbounds i8, i8* %tmp260, i64 1
    %tmp262 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp263 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp264 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp265 = extractvalue { i8*, i64 } %tmp264, 0
    %tmp266 = getelementptr inbounds i8, i8* %tmp265, i64 1
    %tmp267 = load i8, i8* %tmp266
    %tmp268 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp269 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp270 = load { i8*, i64 }, { i8*, i64 }* %tmp233
    %tmp271 = extractvalue { i8*, i64 } %tmp270, 0
    %tmp272 = getelementptr inbounds i8, i8* %tmp271, i64 1
    %tmp273 = load i8, i8* %tmp272
    %tmp274 = icmp ne i8 %tmp273, 105
    br i1 %tmp274, label %if_then.21, label %if_else.22
if_then.21:
    %tmp275 = trunc i64 3 to i32
    ret i32 %tmp275
if_else.22:
    br label %if_end.23
if_end.23:
    %tmp276 = getelementptr inbounds [3 x i8], [3 x i8]* @.str.1, i64 0, i64 0
    %tmp277 = insertvalue { i8*, i64 } undef, i8* %tmp276, 0
    %tmp278 = insertvalue { i8*, i64 } %tmp277, i64 2, 1
    %tmp279 = call %class.string.String @"string.String.from"({ i8*, i64 } %tmp278)
    %tmp280 = alloca %class.string.String
    store %class.string.String %tmp279, %class.string.String* %tmp280
    %tmp281 = load %class.string.String, %class.string.String* %tmp280
    %tmp282 = call i64 @"string.String.length"(%class.string.String* %tmp280)
    %tmp283 = load %class.string.String, %class.string.String* %tmp280
    %tmp284 = call i64 @"string.String.length"(%class.string.String* %tmp280)
    %tmp285 = icmp ne i64 %tmp284, 2
    br i1 %tmp285, label %if_then.24, label %if_else.25
if_then.24:
    %tmp286 = trunc i64 4 to i32
    call void @"string.String.destroy"(%class.string.String* %tmp280)
    ret i32 %tmp286
if_else.25:
    br label %if_end.26
if_end.26:
    %tmp287 = load %class.string.String, %class.string.String* %tmp280
    %tmp288 = call i8* @"string.String.c_str"(%class.string.String* %tmp280)
    %tmp289 = getelementptr inbounds i8, i8* %tmp288, i64 0
    %tmp290 = load %class.string.String, %class.string.String* %tmp280
    %tmp291 = call i8* @"string.String.c_str"(%class.string.String* %tmp280)
    %tmp292 = load %class.string.String, %class.string.String* %tmp280
    %tmp293 = call i8* @"string.String.c_str"(%class.string.String* %tmp280)
    %tmp294 = getelementptr inbounds i8, i8* %tmp293, i64 0
    %tmp295 = load i8, i8* %tmp294
    %tmp296 = load %class.string.String, %class.string.String* %tmp280
    %tmp297 = call i8* @"string.String.c_str"(%class.string.String* %tmp280)
    %tmp298 = load %class.string.String, %class.string.String* %tmp280
    %tmp299 = call i8* @"string.String.c_str"(%class.string.String* %tmp280)
    %tmp300 = getelementptr inbounds i8, i8* %tmp299, i64 0
    %tmp301 = load i8, i8* %tmp300
    %tmp302 = icmp ne i8 %tmp301, 72
    br i1 %tmp302, label %if_then.27, label %if_else.28
if_then.27:
    %tmp303 = trunc i64 5 to i32
    call void @"string.String.destroy"(%class.string.String* %tmp280)
    ret i32 %tmp303
if_else.28:
    br label %if_end.29
if_end.29:
    %tmp304 = load %class.string.String, %class.string.String* %tmp280
    %tmp305 = call i8* @"string.String.c_str"(%class.string.String* %tmp280)
    %tmp306 = getelementptr inbounds i8, i8* %tmp305, i64 1
    %tmp307 = load %class.string.String, %class.string.String* %tmp280
    %tmp308 = call i8* @"string.String.c_str"(%class.string.String* %tmp280)
    %tmp309 = load %class.string.String, %class.string.String* %tmp280
    %tmp310 = call i8* @"string.String.c_str"(%class.string.String* %tmp280)
    %tmp311 = getelementptr inbounds i8, i8* %tmp310, i64 1
    %tmp312 = load i8, i8* %tmp311
    %tmp313 = load %class.string.String, %class.string.String* %tmp280
    %tmp314 = call i8* @"string.String.c_str"(%class.string.String* %tmp280)
    %tmp315 = load %class.string.String, %class.string.String* %tmp280
    %tmp316 = call i8* @"string.String.c_str"(%class.string.String* %tmp280)
    %tmp317 = getelementptr inbounds i8, i8* %tmp316, i64 1
    %tmp318 = load i8, i8* %tmp317
    %tmp319 = icmp ne i8 %tmp318, 105
    br i1 %tmp319, label %if_then.30, label %if_else.31
if_then.30:
    %tmp320 = trunc i64 6 to i32
    call void @"string.String.destroy"(%class.string.String* %tmp280)
    ret i32 %tmp320
if_else.31:
    br label %if_end.32
if_end.32:
    %tmp321 = trunc i64 0 to i32
    call void @"string.String.destroy"(%class.string.String* %tmp280)
    ret i32 %tmp321
}
