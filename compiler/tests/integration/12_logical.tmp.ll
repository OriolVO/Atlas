...
entry:
    %a.addr.0 = alloca i1
    %b.addr.1 = alloca i1
    store i1 1, i1* %a.addr.0
    store i1 0, i1* %b.addr.1
    %tmp0 = load i1, i1* %a.addr.0
    %tmp1 = load i1, i1* %b.addr.1
    %tmp2 = or i1 %tmp1, 1
    %tmp3 = and i1 %tmp0, %tmp2
    br i1 %tmp3, label %if.then.0, label %if.end.0
if.then.0:
    ret i64 42
if.end.0:
    ret i64 0
