...
entry:
    ...
    %s.addr.10 = alloca %class.string.String
    %tmp17 = alloca %class.string.String
    %slice.alloca.11 = alloca { i8*, i64 }
    %tmp26 = alloca %class.string.String
    %first.addr.12 = alloca %class.string.String
    %tmp31 = alloca %class.string.String
    ...
    call void @"array.Array_string.String.push"(%class.array.Array_string.String* %arr.addr.7, %class.string.String %tmp15)
    %tmp16 = call %class.string.String @"array.Array_string.String.pop"(%class.array.Array_string.String* %arr.addr.7)
    store %class.string.String %tmp16, %class.string.String* %tmp17
    %tmp18 = load %class.string.String, %class.string.String* %tmp17
    store %class.string.String %tmp18, %class.string.String* %s.addr.10
    %tmp19 = call i64 @"array.Array_string.String.length"(%class.array.Array_string.String* %arr.addr.7)
    %tmp20 = icmp ne i64 %tmp19, 1
    br i1 %tmp20, label %if.then.11, label %if.end.11
if.then.11:
    call void @"string.String.destroy"(%class.string.String* %s.addr.10)
    call void @"array.Array_string.String.destroy"(%class.array.Array_string.String* %arr.addr.7)
    ret i64 1
if.end.11:
    %tmp21 = getelementptr inbounds [6 x i8], [6 x i8]* @.str.2, i64 0, i64 0
    %tmp22 = getelementptr { i8*, i64 }, { i8*, i64 }* %slice.alloca.11, i32 0, i32 0
    store i8* %tmp21, i8** %tmp22
    %tmp23 = getelementptr { i8*, i64 }, { i8*, i64 }* %slice.alloca.11, i32 0, i32 1
    store i64 5, i64* %tmp23
    %tmp24 = load { i8*, i64 }, { i8*, i64 }* %slice.alloca.11
    ...
    call void @"array.Array_string.String.insert"(%class.array.Array_string.String* %arr.addr.7, i64 0, %class.string.String %tmp27)
    %tmp28 = call i64 @"array.Array_string.String.length"(%class.array.Array_string.String* %arr.addr.7)
    %tmp29 = icmp ne i64 %tmp28, 2
    br i1 %tmp29, label %if.then.12, label %if.end.12
if.then.12:
    call void @"string.String.destroy"(%class.string.String* %s.addr.10)
    call void @"array.Array_string.String.destroy"(%class.array.Array_string.String* %arr.addr.7)
    ret i64 2
if.end.12:
    %tmp30 = call %class.string.String @"array.Array_string.String.remove"(%class.array.Array_string.String* %arr.addr.7, i64 0)
    store %class.string.String %tmp30, %class.string.String* %tmp31
    %tmp32 = load %class.string.String, %class.string.String* %tmp31
    store %class.string.String %tmp32, %class.string.String* %first.addr.12
    %tmp33 = call i64 @"array.Array_string.String.length"(%class.array.Array_string.String* %arr.addr.7)
    %tmp34 = icmp ne i64 %tmp33, 1
    br i1 %tmp34, label %if.then.13, label %if.end.13
if.then.13:
    call void @"string.String.destroy"(%class.string.String* %first.addr.12)
    call void @"string.String.destroy"(%class.string.String* %s.addr.10)
    call void @"array.Array_string.String.destroy"(%class.array.Array_string.String* %arr.addr.7)
    ret i64 3
if.end.13:
    call void @"array.Array_string.String.clear"(%class.array.Array_string.String* %arr.addr.7)
    %tmp35 = call i64 @"array.Array_string.String.length"(%class.array.Array_string.String* %arr.addr.7)
    %tmp36 = icmp ne i64 %tmp35, 0
    br i1 %tmp36, label %if.then.14, label %if.end.14
if.then.14:
    call void @"string.String.destroy"(%class.string.String* %first.addr.12)
    call void @"string.String.destroy"(%class.string.String* %s.addr.10)
    call void @"array.Array_string.String.destroy"(%class.array.Array_string.String* %arr.addr.7)
...
entry:
    ...
    %new_cap.addr.13 = alloca i64
    %new_data.addr.14 = alloca %class.string.String*
    store %class.array.Array_string.String* %self, %class.array.Array_string.String** %self.addr
    ...
    br i1 %tmp6, label %if.then.15, label %if.end.15
if.then.15:
    store i64 4, i64* %new_cap.addr.13
    ...
    br i1 %tmp10, label %if.then.16, label %if.end.16
if.then.16:
    ...
    store i64 %tmp14, i64* %new_cap.addr.13
    br label %if.end.16
if.end.16:
    %tmp15 = load i64, i64* %new_cap.addr.13
    ...
    store %class.string.String* %tmp20, %class.string.String** %new_data.addr.14
    ...
    br i1 %tmp24, label %if.then.17, label %if.end.17
if.then.17:
    %tmp25 = load %class.string.String*, %class.string.String** %new_data.addr.14
    ...
    br label %if.end.17
if.end.17:
    %tmp42 = load i64, i64* %new_cap.addr.13
    ...
    %tmp45 = load %class.string.String*, %class.string.String** %new_data.addr.14
...
entry:
    ...
    br i1 %tmp3, label %if.then.18, label %if.end.18
if.then.18:
...
entry:
    ...
    br i1 %tmp7, label %if.then.19, label %if.end.19
if.then.19:
...
entry:
    ...
    %tmp6 = icmp sge i64 %tmp2, %tmp5
    %tmp7 = or i1 %tmp1, %tmp6
    br i1 %tmp7, label %if.then.20, label %if.end.20
if.then.20:
    %tmp8 = trunc i64 1 to i32
    call void @"exit"(i32 %tmp8)
    br label %if.end.20
...
entry:
    ...
    %index.addr = alloca i64
    %item.addr = alloca %class.string.String
    %new_cap.addr.15 = alloca i64
    %new_data.addr.16 = alloca %class.string.String*
    ...
    %tmp7 = or i1 %tmp1, %tmp6
    br i1 %tmp7, label %if.then.21, label %if.end.21
if.then.21:
    %tmp8 = trunc i64 1 to i32
    call void @"exit"(i32 %tmp8)
    br label %if.end.21
if.end.21:
    ...
    br i1 %tmp15, label %if.then.22, label %if.else.22
if.then.22:
    store i64 4, i64* %new_cap.addr.15
    ...
    br i1 %tmp19, label %if.then.23, label %if.end.23
if.then.23:
    ...
    store i64 %tmp23, i64* %new_cap.addr.15
    br label %if.end.23
if.end.23:
    %tmp24 = load i64, i64* %new_cap.addr.15
    ...
    store %class.string.String* %tmp29, %class.string.String** %new_data.addr.16
    ...
    br i1 %tmp33, label %if.then.24, label %if.end.24
if.then.24:
    %tmp34 = load i64, i64* %index.addr
    %tmp35 = icmp sgt i64 %tmp34, 0
    br i1 %tmp35, label %if.then.25, label %if.end.25
if.then.25:
    %tmp36 = load %class.string.String*, %class.string.String** %new_data.addr.16
...
if.end.25:
    ...
    br i1 %tmp51, label %if.then.26, label %if.end.26
if.then.26:
    %tmp52 = load i64, i64* %index.addr
    %tmp53 = add i64 %tmp52, 1
    %tmp54 = load %class.string.String*, %class.string.String** %new_data.addr.16
...
if.end.26:
    ...
    br label %if.end.24
if.end.24:
    %tmp76 = load i64, i64* %new_cap.addr.15
    ...
    %tmp79 = load %class.string.String*, %class.string.String** %new_data.addr.16
...
if.else.22:
    ...
    store i64 %tmp84, i64* %i.addr.17
    br label %while.cond.27
while.cond.27:
    %tmp85 = load i64, i64* %i.addr.17
    %tmp86 = load i64, i64* %index.addr
    %tmp87 = icmp sgt i64 %tmp85, %tmp86
    br i1 %tmp87, label %while.body.27, label %while.end.27
while.body.27:
    %tmp88 = load i64, i64* %i.addr.17
    ...
    %tmp104 = load i64, i64* %i.addr.17
    %tmp105 = sub i64 %tmp104, 1
    store i64 %tmp105, i64* %i.addr.17
    br label %while.cond.27
while.end.27:
    br label %if.end.22
if.end.22:
...
entry:
    %self.addr = alloca %class.array.Array_string.String*
    %index.addr = alloca i64
    %temp.addr.18 = alloca %class.string.String*
    %i.addr.19 = alloca i64
    store %class.array.Array_string.String* %self, %class.array.Array_string.String** %self.addr
    store i64 %index, i64* %index.addr
    %tmp0 = load i64, i64* %index.addr
    %tmp1 = icmp slt i64 %tmp0, 0
    ...
    %tmp6 = icmp sge i64 %tmp2, %tmp5
    %tmp7 = or i1 %tmp1, %tmp6
    br i1 %tmp7, label %if.then.28, label %if.end.28
if.then.28:
    %tmp8 = trunc i64 1 to i32
    call void @"exit"(i32 %tmp8)
    br label %if.end.28
if.end.28:
    ...
    store %class.string.String* %tmp12, %class.string.String** %temp.addr.18
    %tmp13 = load i64, i64* %index.addr
    store i64 %tmp13, i64* %i.addr.19
    br label %while.cond.29
while.cond.29:
    %tmp14 = load i64, i64* %i.addr.19
    %tmp15 = load %class.array.Array_string.String*, %class.array.Array_string.String** %self.addr
    ...
    br i1 %tmp19, label %while.body.29, label %while.end.29
while.body.29:
    %tmp20 = load %class.string.String*, %class.string.String** %temp.addr.18
    %tmp21 = bitcast %class.string.String* %tmp20 to i8*
    %tmp22 = load i64, i64* %i.addr.19
    ...
    %tmp54 = load %class.string.String*, %class.string.String** %temp.addr.18
    %tmp55 = bitcast %class.string.String* %tmp54 to i8*
    ...
    %tmp59 = load i64, i64* %i.addr.19
    %tmp60 = add i64 %tmp59, 1
    store i64 %tmp60, i64* %i.addr.19
    br label %while.cond.29
while.end.29:
    %tmp61 = load %class.string.String*, %class.string.String** %temp.addr.18
    %tmp62 = bitcast %class.string.String* %tmp61 to i8*
...
entry:
    %self.addr = alloca %class.array.Array_string.String*
    %i.addr.20 = alloca i64
    store %class.array.Array_string.String* %self, %class.array.Array_string.String** %self.addr
    store i64 0, i64* %i.addr.20
    br label %while.cond.30
while.cond.30:
    %tmp0 = load i64, i64* %i.addr.20
    ...
    %tmp3 = load i64, i64* %tmp2
    %tmp4 = icmp slt i64 %tmp0, %tmp3
    br i1 %tmp4, label %while.body.30, label %while.end.30
while.body.30:
    %tmp5 = load i64, i64* %i.addr.20
    ...
    %tmp10 = load i64, i64* %i.addr.20
    %tmp11 = add i64 %tmp10, 1
    store i64 %tmp11, i64* %i.addr.20
    br label %while.cond.30
while.end.30:
    %tmp12 = load %class.array.Array_string.String*, %class.array.Array_string.String** %self.addr
...
entry:
    ...
    br i1 %tmp3, label %if.then.31, label %if.end.31
if.then.31:
    store i64 0, i64* %i.addr.21
    br label %while.cond.32
while.cond.32:
    %tmp4 = load i64, i64* %i.addr.21
    %tmp5 = load %class.array.Array_string.String*, %class.array.Array_string.String** %self.addr
    %tmp6 = getelementptr %class.array.Array_string.String, %class.array.Array_string.String* %tmp5, i32 0, i32 1
    %tmp7 = load i64, i64* %tmp6
    %tmp8 = icmp slt i64 %tmp4, %tmp7
    br i1 %tmp8, label %while.body.32, label %while.end.32
while.body.32:
    %tmp9 = load i64, i64* %i.addr.21
    %tmp10 = load %class.array.Array_string.String*, %class.array.Array_string.String** %self.addr
    %tmp11 = getelementptr %class.array.Array_string.String, %class.array.Array_string.String* %tmp10, i32 0, i32 0
    %tmp12 = load %class.string.String*, %class.string.String** %tmp11
    %tmp13 = getelementptr %class.string.String, %class.string.String* %tmp12, i64 %tmp9
    call void @"string.String.destroy"(%class.string.String* %tmp13)
    %tmp14 = load i64, i64* %i.addr.21
    %tmp15 = add i64 %tmp14, 1
    store i64 %tmp15, i64* %i.addr.21
    br label %while.cond.32
while.end.32:
    %tmp16 = load %class.array.Array_string.String*, %class.array.Array_string.String** %self.addr
