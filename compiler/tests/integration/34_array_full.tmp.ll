...
entry:
    ...
    %tmp1056 = load %class.array.Array_string.String, %class.array.Array_string.String* %tmp1050
    %tmp1057 = getelementptr inbounds [6 x i8], [6 x i8]* @.str.1, i64 0, i64 0
    %tmp1058 = insertvalue { i8*, i64 } undef, i8* %tmp1057, 0
    %tmp1059 = insertvalue { i8*, i64 } %tmp1058, i64 5, 1
    %tmp1060 = call %class.string.String @"string.String.from"({ i8*, i64 } %tmp1059)
    call void @"array.Array_string.String.push"(%class.array.Array_string.String* %tmp1050, %class.string.String %tmp1060)
    %tmp1061 = load %class.array.Array_string.String, %class.array.Array_string.String* %tmp1050
    %tmp1062 = call %class.string.String @"array.Array_string.String.pop"(%class.array.Array_string.String* %tmp1050)
    %tmp1063 = alloca %class.string.String
    store %class.string.String %tmp1062, %class.string.String* %tmp1063
    %tmp1064 = load %class.array.Array_string.String, %class.array.Array_string.String* %tmp1050
    %tmp1065 = call i64 @"array.Array_string.String.length"(%class.array.Array_string.String* %tmp1050)
    %tmp1066 = load %class.array.Array_string.String, %class.array.Array_string.String* %tmp1050
    %tmp1067 = call i64 @"array.Array_string.String.length"(%class.array.Array_string.String* %tmp1050)
    %tmp1068 = icmp ne i64 %tmp1067, 1
    br i1 %tmp1068, label %if_then.87, label %if_else.88
if_then.87:
    %tmp1069 = trunc i64 1 to i32
    call void @"string.String.destroy"(%class.string.String* %tmp1063)
    call void @"array.Array_string.String.destroy"(%class.array.Array_string.String* %tmp1050)
    ret i32 %tmp1069
if_else.88:
    br label %if_end.89
if_end.89:
    %tmp1070 = load %class.array.Array_string.String, %class.array.Array_string.String* %tmp1050
    %tmp1071 = getelementptr inbounds [6 x i8], [6 x i8]* @.str.2, i64 0, i64 0
    %tmp1072 = insertvalue { i8*, i64 } undef, i8* %tmp1071, 0
    %tmp1073 = insertvalue { i8*, i64 } %tmp1072, i64 5, 1
    %tmp1074 = call %class.string.String @"string.String.from"({ i8*, i64 } %tmp1073)
    call void @"array.Array_string.String.insert"(%class.array.Array_string.String* %tmp1050, i64 0, %class.string.String %tmp1074)
    %tmp1075 = load %class.array.Array_string.String, %class.array.Array_string.String* %tmp1050
    %tmp1076 = call i64 @"array.Array_string.String.length"(%class.array.Array_string.String* %tmp1050)
    %tmp1077 = load %class.array.Array_string.String, %class.array.Array_string.String* %tmp1050
    %tmp1078 = call i64 @"array.Array_string.String.length"(%class.array.Array_string.String* %tmp1050)
    %tmp1079 = icmp ne i64 %tmp1078, 2
    br i1 %tmp1079, label %if_then.90, label %if_else.91
if_then.90:
    %tmp1080 = trunc i64 2 to i32
    call void @"string.String.destroy"(%class.string.String* %tmp1063)
    call void @"array.Array_string.String.destroy"(%class.array.Array_string.String* %tmp1050)
    ret i32 %tmp1080
if_else.91:
    br label %if_end.92
if_end.92:
    %tmp1081 = load %class.array.Array_string.String, %class.array.Array_string.String* %tmp1050
    %tmp1082 = call %class.string.String @"array.Array_string.String.remove"(%class.array.Array_string.String* %tmp1050, i64 0)
    %tmp1083 = alloca %class.string.String
    store %class.string.String %tmp1082, %class.string.String* %tmp1083
    %tmp1084 = load %class.array.Array_string.String, %class.array.Array_string.String* %tmp1050
    %tmp1085 = call i64 @"array.Array_string.String.length"(%class.array.Array_string.String* %tmp1050)
    %tmp1086 = load %class.array.Array_string.String, %class.array.Array_string.String* %tmp1050
    %tmp1087 = call i64 @"array.Array_string.String.length"(%class.array.Array_string.String* %tmp1050)
    %tmp1088 = icmp ne i64 %tmp1087, 1
    br i1 %tmp1088, label %if_then.93, label %if_else.94
if_then.93:
    %tmp1089 = trunc i64 3 to i32
    call void @"string.String.destroy"(%class.string.String* %tmp1083)
    call void @"string.String.destroy"(%class.string.String* %tmp1063)
    call void @"array.Array_string.String.destroy"(%class.array.Array_string.String* %tmp1050)
    ret i32 %tmp1089
if_else.94:
    br label %if_end.95
if_end.95:
    %tmp1090 = load %class.array.Array_string.String, %class.array.Array_string.String* %tmp1050
    call void @"array.Array_string.String.clear"(%class.array.Array_string.String* %tmp1050)
    %tmp1091 = load %class.array.Array_string.String, %class.array.Array_string.String* %tmp1050
    %tmp1092 = call i64 @"array.Array_string.String.length"(%class.array.Array_string.String* %tmp1050)
    %tmp1093 = load %class.array.Array_string.String, %class.array.Array_string.String* %tmp1050
    %tmp1094 = call i64 @"array.Array_string.String.length"(%class.array.Array_string.String* %tmp1050)
    %tmp1095 = icmp ne i64 %tmp1094, 0
    br i1 %tmp1095, label %if_then.96, label %if_else.97
if_then.96:
    %tmp1096 = trunc i64 4 to i32
    call void @"string.String.destroy"(%class.string.String* %tmp1083)
    call void @"string.String.destroy"(%class.string.String* %tmp1063)
    call void @"array.Array_string.String.destroy"(%class.array.Array_string.String* %tmp1050)
    ret i32 %tmp1096
