...
define i64 @main() {
entry:
    %arr.addr.0 = alloca [5 x i64]
    %sum.addr.1 = alloca i64
    %tmp0 = getelementptr [5 x i64], [5 x i64]* %arr.addr.0, i32 0, i64 0
    store i64 5, i64* %tmp0
    %tmp1 = getelementptr [5 x i64], [5 x i64]* %arr.addr.0, i32 0, i64 1
    store i64 10, i64* %tmp1
    %tmp2 = getelementptr [5 x i64], [5 x i64]* %arr.addr.0, i32 0, i64 2
    store i64 15, i64* %tmp2
    %tmp3 = getelementptr [5 x i64], [5 x i64]* %arr.addr.0, i32 0, i64 3
    store i64 20, i64* %tmp3
    %tmp4 = getelementptr [5 x i64], [5 x i64]* %arr.addr.0, i32 0, i64 4
    store i64 25, i64* %tmp4
    %tmp5 = getelementptr [5 x i64], [5 x i64]* %arr.addr.0, i32 0, i64 0
    %tmp6 = load i64, i64* %tmp5
    %tmp7 = getelementptr [5 x i64], [5 x i64]* %arr.addr.0, i32 0, i64 1
    %tmp8 = load i64, i64* %tmp7
    %tmp9 = add i64 %tmp6, %tmp8
    %tmp10 = getelementptr [5 x i64], [5 x i64]* %arr.addr.0, i32 0, i64 2
    %tmp11 = load i64, i64* %tmp10
    %tmp12 = add i64 %tmp9, %tmp11
    store i64 %tmp12, i64* %sum.addr.1
    %tmp13 = load i64, i64* %sum.addr.1
    ret i64 %tmp13
}
