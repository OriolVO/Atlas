...
define i64 @main() {
entry:
    %i_fmt.addr.7 = alloca %class.string.String
    %tmp1 = alloca %class.string.String
    %b_fmt.addr.8 = alloca %class.string.String
    %tmp4 = alloca %class.string.String
    %c_fmt.addr.9 = alloca %class.string.String
    %tmp7 = alloca %class.string.String
    %h1.addr.10 = alloca i64
    %tmp0 = call %class.string.String @"primitive_int_format"(i64 42)
    store %class.string.String %tmp0, %class.string.String* %tmp1
    %tmp2 = load %class.string.String, %class.string.String* %tmp1
    store %class.string.String %tmp2, %class.string.String* %i_fmt.addr.7
    %tmp3 = call %class.string.String @"primitive_bool_format"(i1 1)
    store %class.string.String %tmp3, %class.string.String* %tmp4
    %tmp5 = load %class.string.String, %class.string.String* %tmp4
    store %class.string.String %tmp5, %class.string.String* %b_fmt.addr.8
    %tmp6 = call %class.string.String @"primitive_char_format"(i8 65)
    store %class.string.String %tmp6, %class.string.String* %tmp7
    %tmp8 = load %class.string.String, %class.string.String* %tmp7
    store %class.string.String %tmp8, %class.string.String* %c_fmt.addr.9
    call void @"io.println_int"(i64 42)
    call void @"io.println_bool"(i1 0)
    call void @"io.println_char"(i8 90)
    %tmp9 = call i1 @"primitive_int_equals"(i64 42, i64 42)
    %tmp10 = xor i1 %tmp9, 1
    br i1 %tmp10, label %if.then.11, label %if.end.11
if.then.11:
    %tmp11 = trunc i64 1 to i32
    call void @"exit"(i32 %tmp11)
    br label %if.end.11
if.end.11:
    %tmp12 = call i1 @"primitive_bool_equals"(i1 1, i1 0)
    br i1 %tmp12, label %if.then.12, label %if.end.12
if.then.12:
    %tmp13 = trunc i64 2 to i32
    call void @"exit"(i32 %tmp13)
    br label %if.end.12
if.end.12:
    %tmp14 = call i1 @"primitive_char_equals"(i8 88, i8 88)
    %tmp15 = xor i1 %tmp14, 1
    br i1 %tmp15, label %if.then.13, label %if.end.13
if.then.13:
    %tmp16 = trunc i64 3 to i32
    call void @"exit"(i32 %tmp16)
    br label %if.end.13
if.end.13:
    %tmp17 = call i64 @"primitive_int_hash"(i64 100)
    store i64 %tmp17, i64* %h1.addr.10
    %tmp18 = load i64, i64* %h1.addr.10
    %tmp19 = icmp ne i64 %tmp18, 100
    br i1 %tmp19, label %if.then.14, label %if.end.14
if.then.14:
    %tmp20 = trunc i64 4 to i32
    call void @"exit"(i32 %tmp20)
    br label %if.end.14
if.end.14:
    call void @"string.String.destroy"(%class.string.String* %c_fmt.addr.9)
    call void @"string.String.destroy"(%class.string.String* %b_fmt.addr.8)
    call void @"string.String.destroy"(%class.string.String* %i_fmt.addr.7)
    ret i64 0
}
