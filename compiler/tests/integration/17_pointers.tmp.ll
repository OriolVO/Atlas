...
entry:
    %x.addr.0 = alloca i64
    %px.addr.1 = alloca i64*
    %n.addr.2 = alloca %struct.main.Node
    %tmp1 = alloca %struct.main.Node
    %pn.addr.3 = alloca %struct.main.Node*
    store i64 10, i64* %x.addr.0
    store i64* %x.addr.0, i64** %px.addr.1
    %tmp0 = load i64*, i64** %px.addr.1
    store i64 42, i64* %tmp0
    %tmp2 = getelementptr %struct.main.Node, %struct.main.Node* %tmp1, i32 0, i32 0
    store i64 100, i64* %tmp2
    %tmp3 = load %struct.main.Node, %struct.main.Node* %tmp1
    store %struct.main.Node %tmp3, %struct.main.Node* %n.addr.2
    store %struct.main.Node* %n.addr.2, %struct.main.Node** %pn.addr.3
    %tmp4 = load i64, i64* %x.addr.0
    %tmp5 = load %struct.main.Node*, %struct.main.Node** %pn.addr.3
    %tmp6 = getelementptr %struct.main.Node, %struct.main.Node* %tmp5, i32 0, i32 0
    store i64 %tmp4, i64* %tmp6
    %tmp7 = getelementptr %struct.main.Node, %struct.main.Node* %n.addr.2, i32 0, i32 0
