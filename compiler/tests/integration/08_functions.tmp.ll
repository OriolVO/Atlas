...
entry:
    ...
    %tmp1 = load i64, i64* %x.addr
    %tmp2 = mul i64 %tmp0, %tmp1
    ret i64 %tmp2
}
...
entry:
    ...
    %tmp0 = load i64, i64* %a.addr
    %tmp1 = call i64 @"main.square"(i64 %tmp0)
    %tmp2 = load i64, i64* %b.addr
    %tmp3 = call i64 @"main.square"(i64 %tmp2)
...
define i64 @main() {
entry:
    %tmp0 = call i64 @"main.sum_of_squares"(i64 5, i64 2)
    ret i64 %tmp0
}
