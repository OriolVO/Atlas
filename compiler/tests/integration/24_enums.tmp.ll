...
entry:
    ...
    %tmp0 = load i32, i32* %d.addr
    %tmp1 = icmp eq i32 %tmp0, 0
    br i1 %tmp1, label %match.case.0.body.2, label %match.case.0.next.1
    
match.case.0.body.2:
    ret i64 10
    
match.case.0.next.1:
    %tmp2 = icmp eq i32 %tmp0, 1
    br i1 %tmp2, label %match.case.1.body.4, label %match.case.1.next.3
    
match.case.1.body.4:
    ret i64 20
    
match.case.1.next.3:
    %tmp3 = icmp eq i32 %tmp0, 2
    br i1 %tmp3, label %match.case.2.body.6, label %match.case.2.next.5
    
match.case.2.body.6:
    ret i64 30
    
match.case.2.next.5:
    %tmp4 = icmp eq i32 %tmp0, 3
    br i1 %tmp4, label %match.case.3.body.8, label %match.case.3.next.7
...
entry:
    %d.addr.0 = alloca i32
    store i32 3, i32* %d.addr.0
    %tmp0 = load i32, i32* %d.addr.0
    %tmp1 = call i64 @"main.dir_to_code"(i32 %tmp0)
    ret i64 %tmp1
}
